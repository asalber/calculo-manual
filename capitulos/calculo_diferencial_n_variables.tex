...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.5\textwidth}
			...
			\begin{center}
				\mode<presentation>{
					\resizebox{\textwidth}{!}{\input{img/calculo_diferencial_n_variables/trayectoria_plano}}
				}
				\mode<article>{
					\resizebox{0.4\textwidth}{!}{\input{img/calculo_diferencial_n_variables/trayectoria_plano}}
				}
			\end{center}
		\end{column}
		\begin{column}{0.5\textwidth}
			...
			\begin{center}
				\mode<presentation>{
					\resizebox{\textwidth}{!}{\input{img/calculo_diferencial_n_variables/trayectoria_espacio}}
				}
				\mode<article>{
					\resizebox{0.4\textwidth}{!}{\input{img/calculo_diferencial_n_variables/trayectoria_espacio}}
				}
			\end{center}
		\end{column}
	\end{columns}
...
\begin{frame}
	...
	\begin{center}
		\scalebox{0.8}{\input{img/calculo_diferencial_n_variables/movimiento_curvilineo}}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\scalebox{0.8}{\input{img/calculo_diferencial_n_variables/circunferencia}}
	\end{center}
...
\begin{frame}
	...
	\]
	\begin{center}
		\scalebox{0.8}{\input{img/calculo_diferencial_n_variables/circunferencia_tangente_normal}}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\]
	\begin{center}
		\scalebox{0.8}{\input{img/calculo_diferencial_n_variables/parabola_tangente_normal}}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\]
	\begin{center}
		\scalebox{0.8}{\input{img/calculo_diferencial_n_variables/tangente_trayectoria_espacio}}
	\end{center}
\end{frame}
