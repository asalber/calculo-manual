\section{Geometría Analítica del Espacio}
...
\begin{center}
\scalebox{0.8}{\input{img/geometria_analitica/vector}}
\end{center}
\end{frame}
...
\begin{center}
\scalebox{0.8}{\input{img/geometria_analitica/coordenadas_vector}}
\end{center}
\end{frame} 
...
\]
\begin{center}
\scalebox{0.8}{\input{img/geometria_analitica/vector_puntos}}
\end{center}
\end{frame} 
